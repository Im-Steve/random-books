              ...
              && book.mainCategories.map((category) => (
                <a
                  ...
                  href={getRandomizerUrl({
                    ...
                    subcategory: category === 'Wattpad' ? book.subcategories[0] : null,
                  })}
                  key={category}
                >
                  {category}
                ...
                <a
                  ...
                  href={getRandomizerUrl({
                    mainCategory: Array.isArray(book.mainCategories)
                      ? book.mainCategories.some((mainCategory) => mainCategory.includes('Wattpad')) ? 'Wattpad' : book.mainCategories[0]
                      : '',
